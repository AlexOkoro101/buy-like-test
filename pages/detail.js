        ...
        <div>
            <section className="flex flex-wrap w-full justify-center pt-20 lg:pt-28 px-5 xl:px-0">
                ...
                <div className="car-details-holder px-4 pt-4 pb-12">
                    ...
                    <div className="flex mt-4 lg:mt-0">
                        <div
                            className="details-tab  active px-10 lg:px-16 font-10 font-semibold  primary-black py-0.5"
                        ...
                        <div
                            className="ml-auto px-14 lg:px-20 font-10 font-medium details-tab primary-black py-0.5"
                                    ...
                                    <table>
                                        <tbody>
                                            <tr className="">
                                                ...
                                                <td className="text-xs font-medium sec-gray">
                                                    <input
                                                        id="amount"
            ...
            <section className="w-full mt-20">
                ...
                <div className="flex justify-around flex-wrap">
                    <div className="flex flex-col self-center">
                        ...
                        <p className="pt-5 primary-black font-semibold text-sm text-center">
                            Vehicle location
                        </p>
            ...
            <section className="mt-14 pt-7 w-full px-5 vehicle-details">
                <div className="text-center py-3">
                    ...
                    <p className="primary-blue pt-2 text-xs font-semibold">
                        HIGHLIGHTS
                    </p>
                </div>
            ...
            <section className="py-4 w-full overview-section">
                <div className="flex justify-center px-5">
                    <div className="overview-tab relative mr-6 lg:mr-16 active lg:px-4 lg:text-sm text-xs font-semibold  primary-black lg:py-0.5">
                        <p href className="lg:py-1.5 ">
                            OVERVIEW
                        </p>
                    </div>

                    <div className="overview-tab relative mr-6 lg:mr-16 lg:px-4 lg:text-sm text-xs font-semibold  primary-black lg:py-0.5">
                        <p href className="lg:py-1.5">
                            EQUIPMENT AND OPTIONS
                        </p>
                    </div>

                    <div className="overview-tab relative mr-2 lg:mr-16 lg:px-4 lg:text-sm text-xs font-semibold  primary-black lg:py-0.5">
                        <p href className="lg:py-1.5">
                            AUCTION INFO
                        </p>
                    </div>
                        ...
                        <table className="min-w-full border-separate overview-table">
                            <tbody>
                                <tr className="detail-row mb-2">
                                    ...
                                    <td className="text-sm sec-black font-normal py-2 pr-32">
                                        Grey
                                    </td>
                                    <td></td>
                                </tr>
                        ...
                        <table className="min-w-full border-separate overview-table">
                            <tbody>
                                ...
                                <tr className="detail-row mb-2">
                                    ...
                                    <td className="text-sm sec-black font-normal py-2 lg:pr-32">
                                        Top Type
                                    </td>
                                    <td></td>
                                </tr>
                ...
                <div className="text-center mt-5">
                    <a href="#" className="primary-blue font-semibold text-xs">
                        Show More Details
                    </a>
                </div>
            </section>
                ...
                <div className="flex justify-center flex-wrap mt-4">
                    <div className=" similar-cars-holder p-3 mr-4 mb-5 lg:mb-0">
                        <img
                            ...
                            alt="Tacoma"
                        />
                        <p className="pt-2 primary-black font-medium text-xs"></p>
