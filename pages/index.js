...
const Home = ({ getCars, cars, makes, getMakes }) => {
    const [isComponentFullyMounted, setIsComponentFullyMounted] = useState(false);
            ...
            <main>
                ...
                <section className="Hero__section pt-5 px-2 lg:px-20 w-full">
                    ...
                    <div className="text-center pt-10">
                        <h1 className=" text-3xl md:text-4xl lg:text-4xl pt-12 red font-bold ">WHAT CAR ARE YOU LOOKING FOR? <br />
                        <span className="font-normal tertiary-gray text-2xl ">LET’S HELP YOU FIND IT</span> </h1>
                    </div>
                    ...
                    <section
                        ...
                        className="relative request__estimate px-2 lg:px-20 w-full"
                    >
                        ...
                        <div className="relative px-2 lg:px-20 ">
                            <div className="flex flex-wrap lg:flex-nowrap md:flex-nowrap flex-col-reverse md:flex-row lg:flex-row justify-between pt-10 pb-20 lg:pb-32 ">
                                ...
                                <div className=" w-full md:w-1/2 xl:w-2/5 ">
                                    <div>
                                        <h3 className="primary-red line-60 font-medium text-3xl lg:text-4xl "> CLEAN TITLE CARS <br />
                                            <span className="primary-color rem4 font-semibold ">FILTERED <br /> FOR YOU</span>
                                        </h3>
                    ...
                    <section className="w-full bg-white px-7 md:px-10 lg:px-20 xl:px-40 ">
                        ...
                        <div className="text-center pt-20 lg:pt-16 ">
                            ...
                            <h4 className="primary-color font-bold text-2xl ">FREQUENTLY ASKED QUESTIONS</h4>
                        </div>
                        ...
                        <div className="flex flex-wrap md:flex-nowrap mt-10">
                            ...
                            <div className=" w-full lg:w-1/3 mb-5">
                                <h4 className="faq-header pb-3">Bids and Deposits </h4>

                                <ul>
                                    <li className="pb-2 faq"> <a href="#"> How do I place a bid?</a>
                                    </li>
                                    <li className="pb-2 faq"> <a href="#"> What is a deposit?</a></li>
                                    <li className="pb-2 faq"> <a href="#"> What is a collection?</a></li>
                                    <li className="pb-2 faq all"> <a href="#"> See all questions</a></li>
                                </ul>
                            </div>
                            {/* <!--    Questions here --> */}
                            <div className="w-full lg:w-1/3 mb-5">
