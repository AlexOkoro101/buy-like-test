...
const CarDetails = ({ cars, loading, res, carDetail }) => {
  ...
  useEffect(() => {
    fetch(
      enviroment.BASE_URL + "collections/owner/collections/" + `${userId}`,
      {
        method: "GET",
        redirect: "follow",
    ...
    switch (type) {
      case "truck":
        if (e.target.checked === true) {
          setaddTrucking(true);
          setTotalAmount(parseInt(totalAmount) + parseInt(value) * naira);
        } else {
  ...
  const OpenSendSheetModal = () => {
    if (token) {
      ...
      const sendSheetObj = JSON.stringify({
        ...
        vin: cardD.VIN,
        url:
          "https://buylike-web-git-ts-buylike-web.vercel.app/vin/" + cardD.VIN,
  ...
  const sendSheet = (e) => {
    ...
    const sendSheetObj = JSON.stringify({
      ...
      vin: cardD.VIN,
      url: "https://buylike-web-git-ts-buylike-web.vercel.app/vin/" + cardD.VIN,
      amount: cardD?.buyNowPrice || cardD?.mmrPrice,
      make: cardD.make,
      model: cardD.model,
      year: cardD.year,
  ...
  const getAuctionFee = (price) => {
    const auctionFee =
      Number(price) <= 5000
        ? 350
        : Number(price) > 5000 && Number(price) <= 14000
        ? 450
        : Number(price) > 14000 && Number(price) <= 70000
        ? (3.25 / 100) * Number(price)
        : Number(price) > 70000
        ? 2500
        : 0;
    return auctionFee;
            ...
            <>
                  ...
                  <button>
                    <a
                      href={`https://api.whatsapp.com/send?text=check%20out%20this%20car%20%20${encodeURIComponent(
                        cardD?.vehicleName
                      )}%20%20https://www.buylikedealers.com/vin/${cardD?.VIN}`}
                  ...
                  <button
                    onClick={() => {
                      navigator.clipboard.writeText(
                        "www.buylikedealers.com/" + "vin/" + cardD?.VIN
                      );
              ...
              <div className="flex flex-wrap mt-5 lg:justify-center justify-start px-5 xl:px-0">
                    ...
                    <>
                      ...
                      <div className="overflow-hidden">
                        ...
                        >
                          <div
                            className={
                              page >= (window.innerWidth < 760 ? 3 : 8)
                ...
                <div className="car-details-holder px-4 pt-4 pb-12">
                      ...
                      <div className="flex gap-x-5">
                        <p className="font-11 sec-black font-bold">
                          {cardD?.odometer.length <= 2
                            ? ""
                            : dollarFormatter.format(cardD?.odometer)}{" "}
                          mi
                          <img
                  ...
                  <div className="mt-3">
                    {cardD?.buyNowPrice && (
                      <div className="tabcontent" id="offer-amount">
                            ...
                            <tr className="">
                              ...
                              >
                                ...
                                {dollarFormatter.format(
                                  getAuctionFee(cardD?.buyNowPrice)
                                )}
                              </td>
                                  ...
                                  <td className="text-right px-2">
                                    <label className="detail">
                                      <input
                                        ...
                                        onChange={() =>
                                          settruckAccessory(!truckAccessory)
                                        }
                                ...
                                <td className="text-right px-2">
                                  <label className="detail">
                                    <input
                                      ...
                                      className="focus:outline-none detail self-center"
                                      onChange={() =>
                                        setshipAccessory(!shipAccessory)
                                      }
                                      checked={
              ...
              <section className="w-full mt-20">
                ...
                <div className="flex justify-around flex-col lg:flex-row flex-wrap items-center gap-y-8">
                      ...
                      <div className="timer text-center">
                        ...
                        <div className=" flex w-full justify-center mt-3">
                          ...
                          <p className="sec-black font-medium font-11 ml-4">
                            {new Date(carDetail?.auctionEndTime).toLocaleString(
                              "en-US",
                              {
                                hour: "numeric",
                                hour12: true,
                        ...
                        <div className="flex mt-1.5 justify-center">
                          <div className="flex flex-col ml-2">
                            ...
                            <p className="primary-gray font-6">DAYS</p>
                          </div>
                          ...
                          <div className=" ml-3.5">
                            ...
                            <p className="primary-gray font-6">HOURS</p>
                          </div>
                          ...
                          <div className="flex flex-col ml-3.5">
                            ...
                            <p className="primary-gray font-6">MINUTES</p>
                          </div>
                          ...
                          <div className="flex flex-col ml-3.5">
                            ...
                            <p className="primary-gray font-6">SECONDS</p>
                          </div>
                        </div>
                      </div>
                    </div>
                  ...
                  <div className="flex flex-col self-center mt-14">
                    ...
                    <p className="pt-0.5 primary-gray font-medium font-11 text-center">
                      {new Date(
                        +new Date(carDetail?.auctionEndTime) + deliveryDuration
                      ).toLocaleDateString("en-NG", {
                        weekday: "long",
                        year: "numeric",
                        month: "long",
                    ...
                    <table className="min-w-full border-separate overview-table">
                      <tbody>
                        <tr className="detail-row">
                          ...
                          <td className="turncate text-sm sec-black font-normal py-2">
                            {cardD?.facilitationLocation?.replace(
                              "Manheim",
                              ""
                            )}
                          </td>
                    ...
                    <table className="min-w-full border-separate overview-table">
                      <tbody>
                        ...
                        <tr className="detail-row mb-2">
                          ...
                          <td className="turncate text-sm sec-black font-normal py-2">
                            {new Date(cardD?.auctionEndTime).toLocaleDateString(
                              "en-NG",
                              {
                                year: "numeric",
                                day: "numeric",
                        ...
                        <table className="w-full md:w-1/2 overflow-hidden   border-separate ">
                          <tbody>
                            ...
                            <tr className="detail-row mb-2">
                              ...
                              <td className="turncate text-sm sec-black font-normal py-2">
                                {cardD?.transmission || "Not Specified"}
                              </td>
                            </tr>
                            ...
                            <tr className="detail-row mb-2">
                              ...
                              <td className="turncate text-sm sec-black font-normal py-2">
                                {cardD?.buyNowPrice || "Not specified"}
                              </td>
                            </tr>
                          </tbody>
                        </table>
                          ...
                          >
                            ...
                            <div className="flex pt-2 justify-between">
                              <p className="flex items-center sec-black font-10">
                                ...
                                {ele?.pickupLocation.replace("Manheim", "")}
                              </p>
                            ...
                            <div className="flex font-11 primary-gray pt-1">
                              <p>{ele?.year}</p>
                              <p className="ml-3.5">
                                {dollarFormatter.format(ele?.odometer)}
                                miles
                              </p>
                            </div>
                ...
                >
                  <div className="col-span-6 mb-2">
                    ...
                    <input
                      ...
                      onChange={(e) => setsendSheetEmail(e.target.value)}
                    />
                  </div>
