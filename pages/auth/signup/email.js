...
const EmailSignup = ({ beginLogin }) => {
    ...
    const toastSuccess = () =>
        toast.success(`${error ? error : "Account created Successfully"}`, {
            position: "top-right",
            autoClose: 5000,
            hideProgressBar: true,
            closeOnClick: true,
                    ...
                    <div className="options-holder  mx-auto mt-20 p-5 lg:p-9">
                        <div className="text-center">
                            <p className="text-sm primary-color font-medium">
                                Enter your details to sign up with your email
                                address
                            </p>
                        </div>
                        ...
                        <form className="mt-8" onSubmit={formik.handleSubmit}>
                            ...
                            <div className="flex w-full flex-wrap lg:flex-nowrap md:flex-nowrap lg:mb-5"></div>
