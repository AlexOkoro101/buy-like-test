...
const BidDetails = () => {
    ...
    return (
        ...
        <>
            {CollectionBid?<div className="mt-20"><main className="main mt-32">
                            ...
                            <aside className="sidebar  px-4 md:px-2 lg:pl-24 lg:pr-9 pt-9 pb-4">
                                ...
                                <div
                                    ...
                                    <span className="col-span-3 inline-block overflow-hidden rounded-md">
                                        <img className="w-full" src={CollectionBid?.vehicles[0]?.images[0]?.image_largeUrl} alt="" />
                                    </span>
                                    <div className="col-span-3">
                                        ...
                                        <p className="primary-black font-medium font-11 uppercase">
                                            {dollarFormatter.format(CollectionBid?.bids[0]?.bidAmount)}
                                        </p>
                                    </div>
                                </div>
