  ...
  return (
    <>
      <div className="px-2 lg:px-20 pt-16 ">
          ...
          <div className="flex flex-wrap lg:flex-nowrap justify-center lg:justify-between pt-12 ">
              ...
              <div className="works__holder px-8 pt-10 pb-16 mb-3 md:mx-3 ">
                  ...
                  <p className="filtered__text text-sm font-normal ">Use the filters to find what you’re looking for.
              ...
              <div className="works__holder px-8 pt-10 pb-16 mb-3 ">
                  ...
                  <p className="filtered__text text-sm font-normal ">You can choose suggested price or make an offer.
              ...
              <div className="works__holder px-8 pt-10 pb-16 mb-3 md:mx-3 ">
                  ...
                  <p className="filtered__text text-sm font-normal ">Choose delivery location, make deposit and sign
                      online paper work. </p>
              </div>
              ...
              <div className="works__holder px-8 pt-10 pb-16 mb-3 ">
                  ...
                  <p className="filtered__text text-sm font-normal ">We bid on your selected car, after which you make
      ...
      <div className="text-center mt-5">
          <button type="button"
              className="focus:outline-none text-white text-sm primary-btn px-6 h-9 font-semibold">SEE HOW IT
              WORKS</button>
      </div>
    </>
  );
