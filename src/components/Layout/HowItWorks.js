                ...
                <div className="flex flex-wrap lg:flex-nowrap justify-center lg:justify-between 2xl:justify-evenly pt-12 ">
                    ...
                    <div className="works__holder px-8 pt-9 mb-3 ">
                        <div className="h-16 flex items-center">
                            <img
                                src="./assets/img/vectors/vin-icon.svg "
                                className="my-auto"
                                alt="search-icon "
                            />
                        </div>
                        ...
                        <p className="filtered__text text-sm  leading-6 font-normal pt-2 w-full lg:w-5/6">
                            ...
                            Green light and red light options available.
                        </p>
                    </div>
                    ...
                    <div className="works__holder h-auto lg:h-17 px-8 pt-9 mb-3">
                        ...
                        <p className="filtered__text text-sm  leading-6 font-normal pt-2 w-full lg:w-5/6">
                            You can choose suggested price or make an offer. If
                            it’s a buy now car, click to proceed with the buy
                            now.
                        </p>
                    </div>
                    ...
                    <div className="works__holder h-auto lg:h-17 px-8 pt-9 mb-3">
                        ...
                        <p className="filtered__text text-sm  leading-6 font-normal pt-2 w-full lg:w-5/6">
                            Choose delivery location, make deposit and sign
                            online paper work.
                        </p>
                    </div>
                    ...
                    <div className="works__holder h-auto lg:h-17 px-8 pt-9 mb-3">
                        ...
                        <p className="filtered__text text-sm  leading-6 font-normal pt-2 w-full lg:w-5/6">
                            We bid on your selected car, after which you make
                            final payment and then we deliver the car to you or
                            you pick up.
                        </p>
                    </div>
                </div>
