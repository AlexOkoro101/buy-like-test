                                        ...
                                        >
                                            <>
                                                ...
                                                <div className="flex justify-between">
                                                    ...
                                                    <button className="mx-2 text-red-600 text-sm" onClick={() => deleteCollection(collection?._id)}>
                                                        Delete
                                                    </button>
                                                </div>
                                            </>
                    ...
                    <div id="myModal" className="modal">
                        ...
                        <div className="modal-content relative w-10/12 lg:w-1/3 mx-auto mx-8 md:px-0 md:mt-28 md:px-20 md:py-10">
                            <span onClick={() => {
                                ...
                                setisLoading(false)
                                }} className="close absolute right-5 top-1 text-4xl text-gray-500">&times;</span>
                            {/* <!-- <i className="absolute right-0 fa fa-times" aria-hidden="true"></i> --> */}
                            <form onSubmit={handleEdit} className="font-11 grid grid-cols-6 gap-2 mx-6 py-10 md:mx-0 md:py-0">
                                <div className="col-span-6 mb-2">
                                    <label className="block pb-1.5 font-10 primary-black" htmlFor="card_number">New Collection Name </label>
                                    <input ref={newCollectionName} id="card_number" className="profile-control focus:outline-none p-2 w-full" type="text"
